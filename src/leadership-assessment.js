...
class LeadershipAssessment {
    constructor() {
        ...
        this.leadershipTypes = {
            'HHH': { name: '변혁적 리더', description: '모든 영역에서 높은 점수를 보이는 이상적인 리더십 유형' },
            'HHL': { name: '관계지향 리더', description: '공유참여와 상호작용은 강하지만 성장지향이 부족한 유형' },
            'HLH': { name: '비전제시 리더', description: '공유참여와 성장지향은 강하지만 상호작용이 부족한 유형' },
            'HLL': { name: '민주적 리더', description: '공유참여만 강하고 나머지 영역이 부족한 유형' },
            'LHH': { name: '코칭 리더', description: '상호작용과 성장지향은 강하지만 공유참여가 부족한 유형' },
            'LHL': { name: '지지적 리더', description: '상호작용만 강하고 나머지 영역이 부족한 유형' },
            'LLH': { name: '성과지향 리더', description: '성장지향만 강하고 나머지 영역이 부족한 유형' },
            'LLL': { name: '방임적 리더', description: '모든 영역에서 낮은 점수를 보이는 소극적 리더십 유형' }
        };
